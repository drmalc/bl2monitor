...
{
    public delegate void DataReceivedCallbackType(String str);
    ...
    public class NamedPipeServer
    {
        ...
        private DataReceivedCallbackType callBack;
        ...
        public void Start(DataReceivedCallbackType cb)
        {
            this.callBack = cb;
        ...
        private void Read()
        {
            ...
            while (true)
            {
                ...
                if (ReadLength > 0)
                {
                    ...
                    this.callBack.Invoke(encoder.GetString(Rc, 0, ReadLength));
                    buffer.Initialize();
                }
